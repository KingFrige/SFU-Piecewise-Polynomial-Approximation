# ghdl-sfu13-simulation Specification

## Purpose
Define the GHDL-based SFU_13 verification flow, including Linux input data
generation, RTL compilation, simulation, result analysis, and contributor
documentation.
