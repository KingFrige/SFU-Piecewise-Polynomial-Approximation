# octave-golden-model Specification

## Purpose
Define the GNU Octave golden model entry points, command-line use, and regression checks used to verify the SFU reference implementation on Linux.
